...
const Sidebar = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 flex flex-col items-center py-6">
      ...
      <ul className="w-full max-w-xs px-4 flex flex-col gap-y-4 font-medium">
          ...
          <>
            <li>
              <Link
                ...
                } shadow-lg rounded-lg flex items-center gap-x-3 transition-all duration-300 hover:bg-indigo-500 hover:text-white`}
              >
        ...
        <li>
          <div
            onClick={logout}
            className="px-4 py-3 bg-white text-gray-700 shadow-lg rounded-lg flex items-center gap-x-3 transition-all duration-300 hover:bg-indigo-500 hover:text-white cursor-pointer"
          >
